...
EXPERIMENT_NAME="Qwen2.5-VL-3B-Instruct"

export SAVE_CHECKPOINT_DIR=./verl_checkpoints
# export VLLM_ATTENTION_BACKEND=XFORMERS # vllm + qwen2-7b with flash_attn has some issues

BASEDIR=data/DeepEyes-Datasets-47k
...
REF_MODEL_PATH=../model/Qwen/Qwen2.5-VL-3B-Instruct
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.ppo_mini_batch_size=288 \
